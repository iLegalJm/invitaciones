                  ...
                  <div style={{ paddingRight: 6, paddingTop: 8, paddingBottom: 8 }}>
                    {isLeft ? (
                      ...
                      iconSrc && (
                        ...
                        >
                          <div style={{ width: ICON_SIZE, height: ICON_SIZE, display: 'flex', alignItems: 'center', justifyContent: 'center', filter: 'brightness(0) saturate(100%) invert(13%) sepia(21%) saturate(2333%) hue-rotate(188deg) brightness(95%) contrast(92%)' }}>
